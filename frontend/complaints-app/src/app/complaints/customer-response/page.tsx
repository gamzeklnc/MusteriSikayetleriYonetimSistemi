            ...
            <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-5">
                    ...
                    <div className="bg-slate-50 rounded-xl p-4 border border-slate-100 space-y-3">
                        <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest pb-2 border-b border-slate-200">Şikayet Bilgileri</h3>
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                            {[
                                { label: 'Müşteri', value: complaint.customerName },
                                { label: 'Satıcı', value: complaint.sellerName },
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="bg-emerald-50 rounded-xl p-4 border border-emerald-100 space-y-2">
                            <h3 className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest pb-2 border-b border-emerald-200">Kalite Raporu</h3>
                        ...
                        <div className="bg-blue-50 rounded-xl p-4 border border-blue-100 space-y-2">
                            <h3 className="text-[10px] font-bold text-blue-600 uppercase tracking-widest pb-2 border-b border-blue-200">Yönetim Onayı</h3>
                            <div className="flex items-center gap-2">
                    ...
                    <div className="pt-4 border-t border-slate-100 space-y-4">
                        <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Müşteri Geri Dönüşü İşlemi</h3>
                        ...
                        {isLocked && complaint.customerFeedbackByName && (
                            <div className="flex items-center gap-1.5 px-3 py-2 bg-purple-50 rounded-lg border border-purple-100">
                                <span className="text-[10px] font-bold text-purple-600 uppercase">Geri Dönüşü Yapan:</span>
                        ...
                        <table className="w-full text-left text-[11px]">
                            <thead className="bg-slate-50 text-[10px] uppercase font-bold text-slate-500 border-b border-slate-200 tracking-wider">
                                <tr>
                                    ...
                                    <th className="px-2 py-2.5">Satıcı</th>
                                        ...
                                        <tr key={c.id} className={`transition-colors text-[11px] ${c.isCustomerFeedbackDone ? 'bg-emerald-50/30 hover:bg-emerald-50/50' : 'hover:bg-purple-50/30'}`}>
                                            ...
                                            <td className="px-2 py-2 text-center">
                                                <div className={`inline-flex items-center px-2 py-1 rounded-md text-[10px] font-medium border ${c.status === 'Acik' ? 'bg-amber-50 text-amber-600 border-amber-200' : 'bg-emerald-50 text-emerald-600 border-emerald-200'}`}>
                                                    <span className={`w-1.5 h-1.5 rounded-full mr-1.5 ${c.status === 'Acik' ? 'bg-amber-500' : 'bg-emerald-500'}`} />
